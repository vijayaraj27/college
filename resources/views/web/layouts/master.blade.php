 ...
 <body>
                ...
                <div class="row align-items-center">      
                    <div class="col-lg-7 col-md-6 d-none d-lg-block ">
                        ...
                        <div class="header-social">
                            <div class="marquee"><p class="mb-0">An Autonomous Institution | NBA / NAAC Accredited / IQAC |
                                An ISO 9001 : 2015 Organisation</p>  </div>
                            {{-- <span>
    ...
    <div class="container-fluid">
        <div class="text-right text-xl-right">
             <nav id="mobile-menu">
               {{--    <ul>
                     <li class="{{ Request::path() == '/' ? 'current' : '' }}"><a href="{{ route('home') }}">{{ __('navbar_home') }}
                     </a></li>
                     ...
                     <ul>
                        <li><a href="{{ route('course') }}">course</a></li>
                         ...
                         <li class="{{ Request::is('faq*') ? 'current' : '' }}"><a href="{{ route('faq') }}">{{ __('navbar_faqs') }}</a>
                            <ul>
                                <li ><a href="{{ route('course') }}">course</a></li>
                                 <li class="{{ Request::is('event*') ? 'current' : '' }}"><a href="{{ route('event') }}">{{ __('navbar_event') }}</a></li>
                                 <li class="{{ Request::is('faq*') ? 'current' : '' }}"><a href="{{ route('faq') }}">{{ __('navbar_faqs') }}</a>
    ...
    @yield('content')
    <!-- Content End -->
    <section id="sp-right-sticky"><div class="container"><div class="container-inner"><div class="row"><div id="sp-right1" class="col-lg-12 "><div class="sp-column "><div class="sp-module "><div class="sp-module-content">
        <div class="custom">
            <style type="text/css">
        ...
        a.applyNow-button:hover, a.applyNow-button:focus, a.applyNow-button:visited{color: #fff;}
        ...
        }.ee-register-now.right {padding: 10px 15px !important;}
        }
...
.sticky-logo-grade{
    ...
    z-index: 9999;
        ...
        <div class="ee-register-now right"><a href="#" target="_blank" rel="noopener" class="applyNow-button">Apply Now!</a></div>
        <div class="sticky-social">
        <ul class="list-unstyled main-sticky">
        <li class="drop-social"><a href="#"></a>
        <ul class="list-unstyled sub-social-icons whatsapp">
        <li><a><img  src="{{ asset('/uploads/icons/whatsapp.svg') }}" alt="Admission" class="img-responsive"></a></li>
        <li><a href="https://api.whatsapp.com/send?phone=+918012530325" target="_blank" rel="noopener">
        ...
        <li><a> <img src="{{ asset('/uploads/icons/call.svg') }}" alt="Admission" class="img-responsive"> </a></li>
        <li><a href="tel:+918012530321">+91 80125 30321</a></li>
        </ul>
        </li>
        <li class="drop-social" style="top: 4px;">
        <ul class="list-unstyled sub-social-icons">
        <li><a> <img src="{{ asset('/uploads/icons/socialicon.svg') }}" alt="Admission" class="img-responsive"> </a></li>
        <li><a href="https://www.facebook.com/psrengg" target="_blank" rel="noopener"> <img  src="{{ asset('/uploads/icons/facebook.svg') }}" alt="Facebook" class="img-responsive"> </a></li>
        <li><a href="https://www.instagram.com" target="_blank" rel="noopener"> <img  src="{{ asset('/uploads/icons/insta.svg') }}" alt="Instagram" class="img-responsive"> </a></li>
        <li><a href="https://www.youtube.com/channel/" target="_blank" rel="noopener"> <img  src="{{ asset('/uploads/icons/youtube.svg') }}" alt="Youtube" class="img-responsive"> </a></li>
        <li><a href="https://twitter.com/" target="_blank" rel="noopener"> <img  src="{{ asset('/uploads/icons/twitter.svg') }}" alt="Twitter" class="img-responsive"> </a></li>
        </ul>
        </li>
        </ul>
        </div>
