         ...
         <section class="section-2 with-bg  pt-120 pb-120" id="scroll" style="background: #eff7ff;">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-body">
                            <h3 class="product-title mb-2 wow animated fadeInLeft" data-animation="fadeInLeft" data-delay="500" style="animation-duration: 1000ms;">Upcoming Events</h3>
                            ...
                            <li>
                                <div class="event-content d-flex">
                                    ...
                                    <div class="text pl-10 col-11 align-self-center"><a href="#">
                                        <span class="lineclamp2">Lorem Ipsum is simply dummy text of the printing Lorem Ipsum is simply dummy text of the printing Lorem Ipsum is simply dummy text of the printing </span>
                                    </a></div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-6 wow fadeInRight animated"  data-animation="fadeInRightShorter" data-delay="400" style="animation-duration: 1000ms;">
                        <div class="section-body">
                            <h3 class="product-title mb-2 wow animated fadeInLeft" data-animation="fadeInLeft" data-delay="500" style="animation-duration: 1000ms;">Notifications</h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <ul class="data-list scroll-list" data-autoscroll>
                                <li>
                                    <div class="event-content d-flex">
        ...
        <section class="section-2 with-bg  pt-120 pb-120" id="feature">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="section-body">
                            <h3 class="product-title mb-2 wow animated fadeInLeft" data-animation="fadeInLeft" data-delay="500" style="animation-duration: 1000ms;">800+ Offers till date</h3>
                            <p class="section-text wow animated fadeInLeft" data-animation="fadeInLeft" data-delay="700" style="animation-duration: 1000ms;">
                                We provide placement to students and helps to achieve recruitments conducted by companies. To expertise our students in order to settle in the recent industrial environment and almost recruit them in Multi-National Companies.
                            </p>
                            <div class="mb-2 wow scrolling-box animated fadeInLeft" data-animation="fadeInLeft" data-delay="900" style="animation-duration: 1000ms;">
                                <a href="#specific" class="btn btn-rounded with-border">PSR Replacement Cell</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 wow fadeInRight animated"  data-animation="fadeInRightShorter" data-delay="400" style="animation-duration: 1000ms;">
                        {{-- <figure>
                            <img src="{{ asset('uploads/about-us/'.$about->attach) }}" alt="banner" width="629" height="455">
                        </figure> --}}
