                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ date($setting->date_format, strtotime($row->event_date)) }}
                                            @else
                                        ...
                                        <td>
                                            @if($row->event_time)
                                                <small><i class="far fa-clock"></i> {{ $row->event_time }}</small><br>
                                            @endif
                                            @if($row->venue)
                                                <small><i class="fas fa-map-marker-alt"></i> {{ str_limit($row->venue, 30) }}</small>
                                            @endif
                                        </td>
                                        <td>
                                            @if( $row->status == 1 )
