...
<div class="main-body">
    ...
    <div class="card-block">
        <form id="teachingStaffForm" class="needs-validation" method="POST" action="{{ route($route . '.store', ['departmentId' => $departmentId, 'section' => $section]) }}">
            @csrf
            <div class="row">
                ...
                <div id="teachingStaffContainer" class="col-md-12">
                    ...
                    @php
                        $teachingStaffData = isset($row->teachingStaff) ? json_decode($row->teachingStaff, true) : [];
                    @endphp
                            ...
                            <div class="faculty-entry mb-4">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <input type="text" class="form-control" name="teachingStaffData[{{ $index }}][faculty]" placeholder="Faculty Name" value="{{ $staff['faculty'] }}" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control" name="teachingStaffData[{{ $index }}][qualification]" placeholder="Qualification" value="{{ $staff['qualification'] }}" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input type="email" class="form-control" name="teachingStaffData[{{ $index }}][email]" placeholder="Email" value="{{ $staff['email'] }}" required>
                                    </div>
                                    <div class="form-group col-md-1">
                                        <input type="text" class="form-control" name="teachingStaffData[{{ $index }}][uniqueId]" placeholder="Unique ID" value="{{ $staff['uniqueId'] }}" required>
                                    </div>
                                    <div class="form-group col-md-1">
                                        <input type="text" class="form-control" name="teachingStaffData[{{ $index }}][profileId]" placeholder="Profile ID" value="{{ $staff['profileId'] }}" required>
                                    </div>
                    ...
                    @else
                        <div class="faculty-entry mb-4">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control" name="teachingStaffData[0][faculty]" placeholder="Faculty Name" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <input type="text" class="form-control" name="teachingStaffData[0][qualification]" placeholder="Qualification" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <input type="email" class="form-control" name="teachingStaffData[0][email]" placeholder="Email" required>
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="text" class="form-control" name="teachingStaffData[0][uniqueId]" placeholder="Unique ID" required>
                                </div>
                                <div class="form-group col-md-1">
                                    <input type="text" class="form-control" name="teachingStaffData[0][profileId]" placeholder="Profile ID" required>
                                </div>
                                <div class="form-group col-md-1 text-end">
                                    <button type="button" class="btn btn-danger" onclick="removeFacultyEntry(this)">Remove</button>
                                </div>
                ...
                <div class="col-md-12 text-center mt-4">
                    <button type="button" id="addFacultyBtn" class="btn btn-primary" onclick="addFacultyEntry()">Add Faculty</button>
                </div>
            </div>
...
@if($section === 'non-teaching-staff')
    ...
    <!-- The form and content below will not be displayed because of the exit -->
    <div class="card-block">
        <form id="nonTeachingStaffForm" class="needs-validation" method="POST" action="{{ route($route . '.store', ['departmentId' => $departmentId, 'section' => $section]) }}">
            @csrf
            <div class="row">
                ...
                <div id="nonTeachingStaffContainer" class="col-md-12">
                    ...
                    @php
                        $nonTeachingStaffData = isset($row->nonTeachingStaff) ? json_decode($row->nonTeachingStaff, true) : [];
                    @endphp
                    @if(!empty($nonTeachingStaffData))
                        @foreach($nonTeachingStaffData as $index => $staff)
                            <div class="staff-entry mb-4">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <input type="text" class="form-control" name="nonTeachingStaffData[{{ $index }}][name]" placeholder="Name" value="{{ $staff['name'] }}" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control" name="nonTeachingStaffData[{{ $index }}][qualification]" placeholder="Qualification" value="{{ $staff['qualification'] }}" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input type="text" class="form-control" name="nonTeachingStaffData[{{ $index }}][designation]" placeholder="Designation" value="{{ $staff['designation'] }}" required>
                                    </div>
                                    <div class="form-group col-md-1 text-end">
                    ...
                    @else
                        <div class="staff-entry mb-4">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control" name="nonTeachingStaffData[0][name]" placeholder="Name" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <input type="text" class="form-control" name="nonTeachingStaffData[0][qualification]" placeholder="Qualification" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control" name="nonTeachingStaffData[0][designation]" placeholder="Designation" required>
                                </div>
                                <div class="form-group col-md-1 text-end">
                                    <button type="button" class="btn btn-danger" onclick="removeStaffEntry(this)">Remove</button>
                                </div>
                ...
                <div class="col-md-12 text-center mt-4">
                    <button type="button" id="addStaffBtn" class="btn btn-primary" onclick="addStaffEntry()">Add Staff</button>
                </div>
            </div>
            <div class="text-center mt-4">
