                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control date" name="notification_date" id="notification_date" value="{{ old('notification_date', $row->notification_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="is_new" id="is_new">
                                <option value="0" {{ old('is_new', $row->is_new) == '0' ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('is_new', $row->is_new) == '1' ? 'selected' : '' }}>Yes (Show NEW Badge)</option>
                            </select>
