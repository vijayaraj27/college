                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Editing <strong>Home Page</strong> slider.
                        </div>
                    </div>
                        ...
                        <form action="{{ route($route.'.update', $row->id) }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="sub_title" id="sub_title" rows="3">{{ $row->sub_title }}</textarea>
                                </div>
                                ...
                                <!-- Current Image -->
                                <div class="form-group col-md-6">
                                    <label>{{ __('field_current_thumbnail') }}</label>
                                    @if(is_file('uploads/'.$path.'/'.$row->attach))
                                    <div>
                                        <img style="width:200px; height:150px" src="{{asset('uploads/'.$path.'/'.$row->attach)}}" alt="" srcset="">
                                    </div>
                                    @endif
                                </div>
                                ...
                                <!-- New Image -->
                                <div class="form-group col-md-6">
                                    <label for="attach">{{ __('field_thumbnail') }}</label>
