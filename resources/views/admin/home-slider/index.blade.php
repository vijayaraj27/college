                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> This section manages sliders for the <strong>Home Page</strong> only.
                        </div>
                    </div>
                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img style="width:150px; height:150px" src="{{asset('uploads/'.$path.'/'.$row->attach)}}" alt="" srcset="">
                                            @endif
                                        </td>
                                        <td>
                                            @if( $row->status == 1 )
