                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <a href="{{ route($route.'.index') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i>
                            {{ __('btn_refresh') }}</a>
                        @can($access.'-import')
                        {{--   <a href="{{ route($route.'.import') }}" class="btn btn-dark"><i
                    ...
                    <div class="row gx-2">
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control" name="department" id="department">
                                ...
                                <option value="{{ $department->id }}" @if( $selected_department==$department->
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control" name="designation" id="designation">
                                ...
                                <option value="{{ $designation->id }}" @if( $selected_designation==$designation->id)
                                    selected
                                    @endif>{{ $designation->title }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control" name="role" id="role">
                                ...
                                <option value="{{ $role->id }}" @if( $selected_role==$role->id) selected
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control" name="shift" id="shift">
                                ...
                                <option value="{{ $shift->id }}" @if( $selected_shift==$shift->id) selected
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="rounded-circle" style="width:40px;"
                                            src="{{ asset('uploads/'.$path.'/'.$row->photo) }}" @if($row->gender == 1)
                                    ...
                                    <td>
                                        ...
                                        {{-- @can($access.'-password-print')
                                            <a href="#" class="btn btn-dark btn-sm" onclick="PopupWin('{{ route($route.'.print-password', [$row->id]) }}',
                                        '{{ $title }}', 800, 500);"><i class="fas fa-print"></i>
                                        {{ __('field_password') }}</a>
                                        @endcan --}}
                                        <!-- <form action="{{ route($route.'.send-password', [$row->id]) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-info btn-sm"><i
                                                    class="fas fa-envelope"></i> {{ __('field_password') }}</button>
                                        </form>
                                        <br />
                                        <a href="{{ route($route.'.show', $row->id) }}"
