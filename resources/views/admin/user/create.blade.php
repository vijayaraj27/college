                                ...
                                <label for="father_name">{{ __('field_father_name') }}</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="roles[]" id="role" required>
                                            ...
                                            <option value="{{ $role->id }}" @if(old('roles')==$role->id) selected
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="department" id="department" required>
                                            ...
                                            <option value="{{ $department->id }}" @if(old('department')==$department->
                                                id) selected @endif>{{ $department->title }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="marital_status" id="marital_status">
                                        <option value="">{{ __('select') }}</option>
                                        <option value="1" @if( old('marital_status')==1 ) selected @endif>
                                        ...
                                        <option value="5" @if( old('marital_status')==5 ) selected @endif>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="blood_group" id="blood_group">
                                        <option value="">{{ __('select') }}</option>
                                        <option value="1" @if( old('blood_group')==1 ) selected @endif>{{ __('A+') }}
                                        </option>
                                        <option value="2" @if( old('blood_group')==2 ) selected @endif>{{ __('A-') }}
                                        </option>
                                        <option value="3" @if( old('blood_group')==3 ) selected @endif>{{ __('B+') }}
                                        </option>
                                        <option value="4" @if( old('blood_group')==4 ) selected @endif>{{ __('B-') }}
                                        </option>
                                        <option value="5" @if( old('blood_group')==5 ) selected @endif>{{ __('AB+') }}
                                        </option>
                                        <option value="6" @if( old('blood_group')==6 ) selected @endif>{{ __('AB-') }}
                                        </option>
                                        <option value="7" @if( old('blood_group')==7 ) selected @endif>{{ __('O+') }}
                                        </option>
                                        <option value="8" @if( old('blood_group')==8 ) selected @endif>{{ __('O-') }}
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
