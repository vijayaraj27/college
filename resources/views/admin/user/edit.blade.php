                                ...
                                <label for="father_name">{{ __('field_father_name') }}</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="gender" id="gender" required>
                                            ...
                                            <option value="1" @if( $row->gender == 1 ) selected
                                                @endif>{{ __('gender_male') }}</option>
                                            <option value="2" @if( $row->gender == 2 ) selected
                                                @endif>{{ __('gender_female') }}</option>
                                            <option value="3" @if( $row->gender == 3 ) selected
                                                @endif>{{ __('gender_other') }}</option>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="roles[]" id="role" required>
                                            ...
                                            <option value="{{ $role->id }}" @foreach($userRoles as $userRole)
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="department" id="department" required>
                                            ...
                                            <option value="{{ $department->id }}" @if($row->department_id ==
                                                $department->id) selected @endif>{{ $department->title }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <!-- <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="designation" id="designation" required>
                                            ...
                                            <option value="{{ $designation->id }}" @if($row->designation_id ==
                                                $designation->id) selected @endif>{{ $designation->title }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="invalid-feedback">
                                  {{ __('required_field') }} {{ __('Anniversary Date') }}
                                    ...
                                    <!-- <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="form-control date" name="joining_date"
                                            id="joining_date" value="{{ $row->joining_date }}">
                                        <div class="invalid-feedback">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="marital_status" id="marital_status">
                                        <option value="">{{ __('select') }}</option>
                                        <option value="1" @if( $row->marital_status == 1 ) selected
                                            @endif>{{ __('marital_status_single') }}</option>
                                        <option value="2" @if( $row->marital_status == 2 ) selected
                                            @endif>{{ __('marital_status_married') }}</option>
                                        <option value="3" @if( $row->marital_status == 3 ) selected
                                            @endif>{{ __('marital_status_widowed') }}</option>
                                        <option value="4" @if( $row->marital_status == 4 ) selected
                                            @endif>{{ __('marital_status_divorced') }}</option>
                                        <option value="5" @if( $row->marital_status == 5 ) selected
                                            @endif>{{ __('marital_status_other') }}</option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="blood_group" id="blood_group">
                                        <option value="">{{ __('select') }}</option>
                                        <option value="1" @if( $row->blood_group == 1 ) selected @endif>{{ __('A+') }}
                                        </option>
                                        <option value="2" @if( $row->blood_group == 2 ) selected @endif>{{ __('A-') }}
                                        </option>
                                        <option value="3" @if( $row->blood_group == 3 ) selected @endif>{{ __('B+') }}
                                        </option>
                                        <option value="4" @if( $row->blood_group == 4 ) selected @endif>{{ __('B-') }}
                                        </option>
                                        <option value="5" @if( $row->blood_group == 5 ) selected @endif>{{ __('AB+') }}
                                        </option>
                                        <option value="6" @if( $row->blood_group == 6 ) selected @endif>{{ __('AB-') }}
                                        </option>
                                        <option value="7" @if( $row->blood_group == 7 ) selected @endif>{{ __('O+') }}
                                        </option>
                                        <option value="8" @if( $row->blood_group == 8 ) selected @endif>{{ __('O-') }}
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
        ...
        <content class="form-step">
            ...
            <fieldset class="row scheduler-border">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="graduation_academy" id="graduation_academy"
                        value="{{ $row->graduation_academy }}">
                    <div class="invalid-feedback">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control autonumber" name="year_of_graduation" id="year_of_graduation"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="graduation_field" id="graduation_field"
                        value="{{ $row->graduation_field }}">
                    <div class="invalid-feedback">
        ...
        <fieldset class="row scheduler-border">
            <div class="form-group col-md-4">
                ...
                <select class="form-control" name="contract_type" id="contract_type" disabled>
                    <option value="">{{ __('select') }}</option>
                    <option value="1" @if( $row->contract_type == 1 ) selected
                        @endif>{{ __('contract_type_full_time') }}</option>
                    <option value="2" @if( $row->contract_type == 2 ) selected
                        @endif>{{ __('contract_type_part_time') }}</option>
                </select>
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control" name="work_shift" id="work_shift" disabled>
                    <option value="">{{ __('select') }}</option>
                    @foreach($work_shifts as $shift )
                    <option value="{{ $shift->id }}" {{ $row->work_shift == $shift->id ? 'selected' : '' }}>
                        {{ $shift->title }}</option>
                    @endforeach
                </select>
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control" name="salary_type" id="salary_type" disabled>
                    <option value="">{{ __('select') }}</option>
                    <option value="1" @if( $row->salary_type == 1 ) selected @endif>{{ __('salary_type_fixed') }}
                    </option>
                    <option value="2" @if( $row->salary_type == 2 ) selected @endif>{{ __('salary_type_hourly') }}
                    </option>
                </select>
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control autonumber" name="basic_salary" id="basic_salary"
                    value="{{ $row->basic_salary }}" disabled>
                <div class="invalid-feedback">
    ...
    <content class="form-step">
        ...
        <fieldset class="row scheduler-border">
            <div class="form-group col-md-6">
                ...
                <img src="{{ asset('uploads/'.$path.'/'.$row->photo) }}" class="img-fluid"
            ...
            <img src="{{ asset('uploads/'.$path.'/'.$row->signature) }}" class="img-fluid"
                style="max-width: 80px; max-height: 80px;"
                onerror="this.src='{{ asset('dashboard/images/user/avatar-2.jpg') }}';">
            @endif
</div>
...
<div class="form-group col-md-6">
    ...
    <a href="{{ asset('uploads/'.$path.'/'.$row->resume) }}" class="btn btn-sm btn-icon btn-dark" download><i
...
<div class="form-group col-md-6">
    ...
    <a href="{{ asset('uploads/'.$path.'/'.$row->joining_letter) }}" class="btn btn-sm btn-icon btn-dark" download><i
            class="fas fa-download"></i></a>
    @endif
</div>
@endif
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ asset('uploads/'.$path.'/'.$document->attach) }}" class="btn btn-sm btn-icon btn-dark"
...
(function($) {
    ...
    $(document).on('click', '#addDocument', function() {
        ...
        html += '<div class="form-group col-md-4"><label for="title" class="form-label">{{ __('
        field_title
            ') }} <span>*</span></label><input type="text" class="form-control" name="titles[]" id="title" value="{{ old('
        title ') }}" required><div class="invalid-feedback">{{ __('
        required_field ') }} {{ __('
        field_title ') }}</div></div>';
        html += '<div class="form-group col-md-4"><label for="document" class="form-label">{{ __('
        field_document
            ') }} <span>*</span></label><input type="file" class="form-control" name="documents[]" id="document" value="{{ old('
        document ') }}" required><div class="invalid-feedback">{{ __('
        required_field ') }} {{ __('
        field_document ') }}</div></div>';
        html +=
            '<div class="form-group col-md-4"><button id="removeDocument" type="button" class="btn btn-danger btn-filter"><i class="fas fa-trash-alt"></i> {{ __('
        btn_remove ') }}</button></div>';
        html += '</div>';
