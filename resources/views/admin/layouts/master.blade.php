    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-lightblue">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ms-auto">
                <li>
                    <h3 class="topbar-title for-mobile">
                        {{ Auth::user()->department_id != 0 ? Auth::user()->department->title : '' }}
                    </h3>
                </li>
                {{-- @can('student-attendance-create')
                <li><span class="top-icon"><a href="{{ route('admin.student-attendance.index') }}"><i
                    class="fas fa-user-check"></i></a></span></li>
                @endcan
                @can('fees-student-due')
                <li><span class="top-icon"><a href="{{ route('admin.fees-student.index') }}"><i
                                class="fas fa-money-bill-wave"></i></a></span></li>
                @endcan
                @canany(['book-issue-return-create', 'book-issue-return-view'])
                <li><span class="top-icon"><a href="{{ route('admin.issue-return.index') }}"><i
                                class="fas fa-book-open"></i></a></span></li>
                @endcanany
                @canany(['visitor-create', 'visitor-view'])
                <li><span class="top-icon"><a href="{{ route('admin.visitor.create') }}"><i
                                class="fas fa-calendar-check"></i></a></span></li>
                @endcanany
                @canany(['phone-log-create', 'phone-log-view'])
                <li><span class="top-icon"><a href="{{ route('admin.phone-log.index') }}"><i
                                class="fas fa-phone"></i></a></span></li>
                @endcanany
                @can('setting-view')
                <li><span class="top-icon"><a href="{{ route('admin.setting.index') }}"><i
                                class="fas fa-cog"></i></a></span></li>
                @endcan --}}
                <!-- Language -->
                {{-- <li>
                    <div class="dropdown">
        ...
        <!-- Notification -->
        <li><i class="icon feather icon-help-circle"></i> 9790338991</li>
        {{--   <li>
            <div class="dropdown">
        ...
        <ul class="noti-body">
            ...
            @if($key < 10) @php $notification_link='admin.dashboard.index' ; $notification_type='' ; if($notification->
                data['type'] == 'content') {
                ...
                <li class="notification">
                    <a class="media" href="{{ route($notification_link) }}">
                        <div class="media-body">
                            <p><strong>{{ $notification->data['title'] }}</strong><span class="n-time text-muted"><i
                ...
                <div class="dropdown-menu dropdown-menu-right profile-notification">
                    ...
                    <ul class="pro-body">
                        ...
                        <li><a href="{{ route('admin.profile.index') }}" class="dropdown-item"><i
                                    class="feather icon-user"></i> {{ trans_choice('module_profile', 2) }}</a></li>
                        @endcan
                    </ul>
                </div>
            </div>
        ...
        <div class="pcoded-wrapper">
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                    {{-- <h1> Testing kkkkkk</h1> --}}
                    {{-- @php
                    App\http\Controllers\UserController::show();
                    $users = User::where('id', '!=', null); dd($users);
                    @endphp --}}
                    <!-- start page title -->
