...
Route::middleware(['auth:web', 'XSS'])->name('admin.')->namespace('Admin')->prefix('admin')->group(function () {
 ...
 //Route::get('setting/field-user', 'FieldController@user')->name('field.user');
    ...
    Route::prefix('web')->namespace('Web')->group(function () {
        ...
        // Define resource routes without parameters
        Route::resource('about-us/{departmentId}', AboutUsController::class)->names([
        ...
        // Custom route for store action with departmentId
    Route::post('about-us/store/{departmentId}', [AboutUsController::class, 'store'])
        ->name('admin.about-us.storeWithId');
    });
