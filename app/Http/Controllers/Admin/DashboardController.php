   ...
   */
   public function index()
   {
    ...
    //  Counter Data
     ...
     // dd(json_encode($user, JSON_NUMERIC_CHECK)) die();
  // dd($user->['original']); //die();
   //json_encode($student_fee, JSON_NUMERIC_CHECK)
      //exit;
    // $departmentId = $user->original['department_id'];
      // print_r($departmentId. " DEPARTMENT ID ");
    ...
    // exit;
      ...
      // ->with('student_fee', json_encode($student_fee, JSON_NUMERIC_CHECK))
      // ->with('discounts', json_encode($discounts, JSON_NUMERIC_CHECK))
      // ->with('fines', json_encode($fines, JSON_NUMERIC_CHECK))
      // ->with('fee_paid', json_encode($fee_paid, JSON_NUMERIC_CHECK))
      // ->with('net_salary', json_encode($net_salary, JSON_NUMERIC_CHECK))
      // ->with('total_tax', json_encode($total_tax, JSON_NUMERIC_CHECK))
      // ->with('total_deduction', json_encode($total_deduction, JSON_NUMERIC_CHECK))
      // ->with('total_allowance', json_encode($total_allowance, JSON_NUMERIC_CHECK))
      // ->with('monthly_visitors', json_encode($monthly_visitors,JSON_NUMERIC_CHECK))
      // ->with('monthly_phone_logs', json_encode($monthly_phone_logs,JSON_NUMERIC_CHECK))
      // ->with('monthly_enqueries', json_encode($monthly_enqueries,JSON_NUMERIC_CHECK))
